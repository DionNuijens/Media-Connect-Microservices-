...
public class RabbitMQConfig {
    ...
    public static final String USER_DELETE_RESPONSE_QUEUE = "user.delete.response.queue";
    ...
    @Bean
    public Queue userDeleteResponseQueue() {
        return QueueBuilder.durable(USER_DELETE_RESPONSE_QUEUE).build();
    }
    ...
    @Bean
    public Binding userDeleteResponseBinding(Queue userDeleteResponseQueue, TopicExchange userEventsExchange) {
        return BindingBuilder.bind(userDeleteResponseQueue)
                .to(userEventsExchange)
                .with(USER_DELETE_RESPONSE_KEY);
    }
